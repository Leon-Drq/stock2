...
- `stock2-web`: Next.js 24 application. It owns pages and the existing stock, radar, backtest, and paper-trading routes.
...
The configuration UI should live in `stock2-web` and call `stock2-api`:

- Cron management: `/ops/cron`
- User management: `/ops/users`
- Billing management: `/ops/billing`
